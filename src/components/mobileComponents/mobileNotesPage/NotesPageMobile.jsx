...
import "./NotesPageMobile.css";
import enter from "../../../assets/enter.png";
import back from "../../../assets/back.png";
import home from "../../../assets/home.png";
import NotesContentMobile from "../mobileNotesContent/NotesContentMobile";

function NotesPageMobile({ selected, setSelected, notes, setNotes }) {
        ...
        {notes.length === 0 ? (
          ...
          <div>
            {notes.map((note, index) => (
              <NotesContentMobile key={index} note={note} />
            ))}
          </div>
        )}
      </div>
...
export default NotesPageMobile;